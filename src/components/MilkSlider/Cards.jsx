    ...
    return (
        <>
            ...
            <div className="custom-scrollbar relative px-6 py-6 overflow-x-scroll">
                ...
                {/* Chevrons */}
                <div className="absolute top-60 left-0 z-50 flex items-center justify-center bg-chevron_bg h-20 w-20">
                    <img src={LeftChevron} alt="left chevron" className="h-6 w-6" />
                </div>
                <div className="absolute top-60 right-0 z-50 flex items-center justify-center bg-chevron_bg h-20 w-20">
                    <img src={RightChevron} alt="left chevron" className="h-6 w-6" />
                </div>
